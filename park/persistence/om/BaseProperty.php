...
include_once 'persistence/PropertyPeer.php';
...
abstract class BaseProperty extends BaseObject  implements Persistent {
	...
	public function setValue($v)
	{
		...
		if ($this->value !== $v) {
			$this->value = $v;
			$this->modifiedColumns[] = PropertyPeer::VALUE;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			return $startcol + 4; // 4 = PropertyPeer::NUM_COLUMNS - PropertyPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PropertyPeer::VALUE)) $criteria->add(PropertyPeer::VALUE, $this->value);
