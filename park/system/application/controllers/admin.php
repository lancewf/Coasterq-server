...
class Admin extends Controller
{
	...
	{
		if("207.118.29.3" == $_SERVER['REMOTE_ADDR'])
		{
	   		$data = $this->getData();
	...
	public function updateParkDays()
	{
		...
		foreach(explode(",", $parkDaysText) as $parkDaysItem)
		{
			$item = explode("-", $parkDaysItem);
