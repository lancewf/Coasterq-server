...
include_once 'persistence/RideClosurePeer.php';

/**
 * Base class that represents a row from the 'ride_closure' table.
 *
 ...
 */
abstract class BaseRideClosure extends BaseObject  implements Persistent {
	 ...
	 * The start date of the ride closure
	 ...
	 * The end date of the ride closure
	 * @param      string $format The date/time format string (either date()-style or strftime()-style).
	 *							If format is NULL, then the integer unix timestamp will be returned.
	 * @return     mixed Formatted date/time value as string or integer unix timestamp (if format is NULL).
	 * @throws     PropelException - if unable to convert the date/time to timestamp.
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = RideClosurePeer::ID;
		}
	...
	public function setStartDate($v)
	{
		...
		if ($this->start_date !== $ts) {
			$this->start_date = $ts;
			$this->modifiedColumns[] = RideClosurePeer::START_DATE;
		}
	...
	public function setEndDate($v)
	{
		...
		if ($this->end_date !== $ts) {
			$this->end_date = $ts;
			$this->modifiedColumns[] = RideClosurePeer::END_DATE;
		}
	...
	public function setRideId($v)
	{
		...
		if ($this->ride_id !== $v) {
			$this->ride_id = $v;
			$this->modifiedColumns[] = RideClosurePeer::RIDE_ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->start_date = $rs->getTimestamp($startcol + 1, null);

			$this->end_date = $rs->getTimestamp($startcol + 2, null);

			$this->ride_id = $rs->getInt($startcol + 3);
			...
			return $startcol + 4; // 4 = RideClosurePeer::NUM_COLUMNS - RideClosurePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating RideClosure object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			RideClosurePeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = RideClosurePeer::doInsert($this, $con);
					...
					$affectedRows += RideClosurePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = RideClosurePeer::doValidate($this, $columns)) !== true) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RideClosurePeer::ID)) $criteria->add(RideClosurePeer::ID, $this->id);
		if ($this->isColumnModified(RideClosurePeer::START_DATE)) $criteria->add(RideClosurePeer::START_DATE, $this->start_date);
		if ($this->isColumnModified(RideClosurePeer::END_DATE)) $criteria->add(RideClosurePeer::END_DATE, $this->end_date);
		if ($this->isColumnModified(RideClosurePeer::RIDE_ID)) $criteria->add(RideClosurePeer::RIDE_ID, $this->ride_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(RideClosurePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of RideClosure (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     RideClosure Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     RideClosurePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new RideClosurePeer();
		}
		return self::$peer;
	}
