...
/**
 * This class adds structure of 'property' table to 'persistence' DatabaseMap object.
 *
 *
...
class PropertyMapBuilder {
	 ...
	 */
	const CLASS_NAME = 'persistence.map.PropertyMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('property');
		...
		$tMap->addColumn('TYPE', 'Type', 'string', CreoleTypes::VARCHAR, true, 128);
